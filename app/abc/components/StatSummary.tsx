    ...
    <div className="grid grid-cols-1 sm:grid-cols-2  md:grid-cols-4 lg:grid-cols-6 gap-2.5 py-2.5! ">
      ...
      >
        <CustomStatCard
          ...
          percentage={data?.complaintsGrowthPercentages?.pendingComplaints}
      ...
      >
        <CustomStatCard
          ...
          percentage={data?.complaintsGrowthPercentages?.inProceedingComplaints}
      ...
      >
        <CustomStatCard
          ...
          percentage={data?.complaintsGrowthPercentages?.escalatedComplaints}
      ...
      >
        <CustomStatCard
          ...
          percentage={
            data?.complaintsGrowthPercentages?.superEscalatedComplaints
          }
