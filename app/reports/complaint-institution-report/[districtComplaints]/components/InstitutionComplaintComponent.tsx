...
interface InstitutionComplaintComponentProp {
  data: ComplaintInstitution;
}

const InstitutionComplaintComponent = ({
  data,
}: InstitutionComplaintComponentProp) => {
  return (
    <>
      <Breadcrumbs
        items={[
...

          {
            ...
            href: "/reports/complaint-institution-report/list",
          },
          {
...
export default InstitutionComplaintComponent;
