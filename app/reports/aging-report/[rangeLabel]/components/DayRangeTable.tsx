...
interface DayRangeTableProps {
  rowsData: ManageComplainsData[];
}

const DayRangeTable = ({ rowsData }: DayRangeTableProps) => {
  ...
  return (
    <div className="relative">
      <div className="h-[calc(100vh-145px)] overflow-auto">
        {rowsData?.length === 0 ? (
          <div className="flex justify-center items-center">
            <p className="font-bold text-[#555555]">
              No Complaint found for selected date
            </p>
          </div>
        ) : (
