...
interface ExParteTableProps {
  rowsData: ManageComplainsData[];
  setRefresh: React.Dispatch<React.SetStateAction<boolean>>;
}

const ExParteTable = ({ rowsData, setRefresh }: ExParteTableProps) => {
    ...
    <>
      ...
      <Dialog.Root open={openDialog} onOpenChange={setOpenDialog}>
        <Dialog.Content className="px-0 lg:max-w-[700px]!">
          <ExParteDialog selectedComplaint={selectedComplaint} />
        </Dialog.Content>
      </Dialog.Root>
    </>
  );
